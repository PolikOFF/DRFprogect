"""
Django settings for DRFprogect project.
...
WSGI_APPLICATION = 'DRFprogect.wsgi.application'
...
CELERY_BEAT_SCHEDULE = {
    'blocking_a_user': {
        'task': 'users.tasks.blocking_a_user',  # Путь к задаче
